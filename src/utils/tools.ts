...
export const checkDevice = () => {
  ...
  return {
    isMobile: /iphone|ipod|android|ios|ipad|blackberry|webos|symbian|windows phone|phone/i.test(ua),
    isAndroid: ua.indexOf('android') > -1 || ua.indexOf('adr') > -1,
    isIOS: /iphone|ipad|ipod/.test(ua),
    isWindows: ua.indexOf('windows') !== -1,
    hasTouch: 'ontouchstart' in window || ua.indexOf('touch') !== -1 || ua.indexOf('mobile') !== -1
  }
}
